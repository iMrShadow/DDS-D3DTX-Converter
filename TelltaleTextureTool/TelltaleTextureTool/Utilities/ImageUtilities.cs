...
public static class ImageUtilities
{
    ...
    /// <param name="filePath"></param>
    /// <returns></returns>
    public static Bitmap ConvertD3dtxToBitmap(string filePath, D3DTXVersion D3DTXConversionType = D3DTXVersion.DEFAULT)
    {
        var d3dtx = new D3DTX_Master();
        d3dtx.ReadD3DTXFile(filePath, D3DTXConversionType);
