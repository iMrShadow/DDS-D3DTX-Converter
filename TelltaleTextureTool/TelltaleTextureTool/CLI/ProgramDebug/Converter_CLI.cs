...
public class Converter_CLI
{
    ...
    public static bool ConvertBulk(string texPath, string resultPath, string oldFileType, string newFileType = "", D3DTXVersion conversionType = D3DTXVersion.DEFAULT)
    {
    ...
    private static void PerformConversion(short mode, string sourceFilePath, string destinationDirectory, string newFileType, D3DTXVersion conversionType = D3DTXVersion.DEFAULT)
    {
        switch (mode)
        {
            case 0:
