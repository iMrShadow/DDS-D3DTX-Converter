...
namespace TelltaleTextureTool.Main
{
    ...
    public class TextureMaster
    {
        ...
        public static bool IsValidFormatForDDS(T3SurfaceFormat format)
        {
            ...
            {
                T3SurfaceFormat.eSurface_PVRTC2 or
                T3SurfaceFormat.eSurface_PVRTC4 or
                T3SurfaceFormat.eSurface_PVRTC2a or
                T3SurfaceFormat.eSurface_PVRTC4a or
                T3SurfaceFormat.eSurface_ETC1_RGB or
                T3SurfaceFormat.eSurface_ETC2_RGB or
                T3SurfaceFormat.eSurface_ETC2_RGB1A or
                T3SurfaceFormat.eSurface_ETC2_RGBA or
                T3SurfaceFormat.eSurface_ETC2_R or
                T3SurfaceFormat.eSurface_ETC2_RG or
                T3SurfaceFormat.eSurface_ATSC_RGBA_4x4 or
                T3SurfaceFormat.eSurface_FrontBuffer => false,
                _ => true,
            };
        }
        ...
        public static bool IsValidFormatForKTX(T3SurfaceFormat format)
        {
            switch (format)
            {
                ...
                case T3SurfaceFormat.eSurface_FrontBuffer:
                    return false;
                default:
                    return false;
            }
